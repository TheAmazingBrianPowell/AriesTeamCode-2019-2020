...
//    }
    ...
    static void setUp(HardwareMap hardwareMap) {
        map = hardwareMap;
        motors[0] = map.get(DcMotor.class, "leftFront");
        motors[1] = map.get(DcMotor.class, "rightFront");
        motors[2] = map.get(DcMotor.class, "rightBack");
    ...
    public static void drive(double angle, double power) {
    ...
    public static void drive(double y, double x, double turn, int position) {
        double robotAngle = Math.atan2(y, x) - Math.PI / 4;
    ...
    public static void drive(double angle, double power, int position) {
    ...
    public static void encoderStop(String name) {
    ...
    public static void move(String name, double power, int position) {
        DcMotor motor = map.get(DcMotor.class, name);
    ...
    public static boolean toggleButton(String name, boolean button) {
        int index = 0;
    ...
    public static void gyroAlign(double position) {
