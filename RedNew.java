...
public class RedNew extends LinearOpMode {
	...
	public void runOpMode() {
		...
		move(0,0.5,0);
		while(opModeIsActive() && groundColor.red() < 30) {
			...
			leftFront.setPower(-0.4 - angle3);
			leftBack.setPower(0.48 - angle3);
			rightFront.setPower(0.4 + angle3);
			rightBack.setPower(-0.48 + angle3);
			idle();
		}

		encoderDrive(1,-1,-1,1,2000,0);
		...
		encoderDrive(0.6, 0.3, 0.6, 0.3, 4500);
