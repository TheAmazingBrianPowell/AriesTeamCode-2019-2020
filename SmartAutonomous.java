...
public class SmartAutonomous extends LinearOpMode {
   ...
   public void runOpMode() {
       ...
       //color/distance sensor on the front of robot for sensing bricks' distances from the robot
       ...
       ColorSensor groundSensor = hardwareMap.get(ColorSensor.class, "colorSensor");
       ...
       if (opModeIsActive()) {
          ...
          //rotate the arm for intake
          bigRotate.setPower(1);
          sleep(1000);
          bigRotate.setPower(0);
          //move the slider up
          slide.setPower(1);
          while(slide.getCurrentPosition() > -2800 && opModeIsActive());
          slide.setPower(0);
          ...
          encoderDrive(0.2,0.2,0.2,0.2, 700);
          ...
          encoderDrive(0.2,-0.2,-0.2,0.2,1500);
          ...
          //clamp the claw onto the brick
          clamp1.setPosition(0.3);
          clamp2.setPosition(0.4);
          
          //move the linear slider down
          slide.setPower(-1);
          while(opModeIsActive() && slide.getCurrentPosition() <= -10);
          slide.setPower(0);
          ...
          encoderDrive(0.2,0.2,0.2,0.2,2000);
          encoderDrive(0.2,-0.2,0.2,-0.2, 5000);
          
          telemetry.addData("ground color", groundSensor.red() + "," + groundSensor.blue());
          telemetry.update();
        //   move(0,1,0);
